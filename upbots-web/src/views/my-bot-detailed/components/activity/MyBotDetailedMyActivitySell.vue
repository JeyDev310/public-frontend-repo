<template>
  <div class="flex flex-col space-y-10">
    ...
    <div class="flex items-center space-x-10">
      ...
      <div class="flex">
        <span
          :style="`width: ${emojiData.chart.size}px`"
          class="text-nile-blue dark:text-white"
          v-html="emojiData.chart.code"
        />
      </div>
    ...
    <div class="flex items-center space-x-10">
      ...
      <div class="flex">
        <span
          :style="`width: ${emojiData.bell.size}px`"
          class="text-nile-blue dark:text-white"
          v-html="emojiData.bell.code"
        />
      </div>
...
export default defineComponent({
  name: 'MyBotDetailedMyActivitySell',
  ...
  setup (props) {
    const { botPerfSubscriptionCycles } = useMyBotDetailed()
    ...
    return { getProfiteTrade, getPerformanceFee, getPositionLabel }
  }
})
</script>
